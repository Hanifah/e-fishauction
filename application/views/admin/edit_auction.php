...
<h1>Edit Auction</h1>
<?php echo form_open_multipart('admin/edit_auction/'.$auction_id);?>
  <div class="one-half">
    <fieldset>
  ...
  <div class="one-half last">
      <fieldset>
        <img src=<?php echo base_url().'uploads/'.$viewmodel['image_name']?> width="100px">
      </fieldset> 
      <fieldset>
  ...
  <div style="clear:both; height: 40px;">
    <fieldset>
      <input name="Mysubmitted" id="Mysubmitted" value="Save" class="button white button-submit" type="submit">
    </fieldset>
  </div>
</form>
